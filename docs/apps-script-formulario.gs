 ...
 * 6. Colar essa URL no site (script.js, constante APPS_SCRIPT_URL).
 *
 * Reaproveitável: o mesmo script serve pra qualquer outro site de
 * campanha, basta repetir esses passos numa planilha nova pra cada um.
 */
...
// Só pra você conseguir testar abrindo a URL direto no navegador.
function doGet() {
